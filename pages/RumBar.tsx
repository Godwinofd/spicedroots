...
import { GlassWater, Star, ShieldCheck, MapPin, ArrowRight, Info } from 'lucide-react';
...
const RumBar: React.FC = () => {
    ...
    return (
        <div className="bg-[#F9F8F6] text-[#27618E] overflow-x-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                        ...
                        <h1 className="text-[15vw] sm:text-[9.5rem] font-just-another-hand leading-[0.8] text-white hover:text-[#D1BB94] transition-colors duration-500 cursor-default">
                            THE RUM <span className="italic uppercase">VAULT</span>
                        </h1>
            ...
            {/* 2. Signature Cocktails Section - NEW */}
            <section className="py-24 lg:py-40 px-6 sm:px-12 bg-white">
                <div className="max-w-[1400px] mx-auto">
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-24 gap-8">
                        <div>
                            <span className="text-[#D1BB94] text-xl tracking-[0.4em] uppercase font-just-another-hand mb-4 block">Mixology</span>
                            <h2 className="text-8xl sm:text-[9rem] font-just-another-hand leading-none text-[#27618E] uppercase">
                                SIGNATURE <span className="italic text-[#D1BB94]">CREATIONS</span>
                            </h2>
                        </div>
                        <p className="text-[#27618E]/60 text-3xl font-just-another-hand italic max-w-md leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
                        {rumCocktails.map((cocktail, idx) => (
                            ...
                            >
                                <div className="relative aspect-[3/4] overflow-hidden rounded-2xl mb-8 bg-[#27618E]/5">
                                    <img
                                        src={cocktail.image}
                                        alt={cocktail.name}
                                    ...
                                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg">
                                        <span className="text-[#27618E] font-bold text-sm">£{(cocktail.price as number).toFixed(2)}</span>
                                    </div>
                                </div>
                                <h3 className="text-4xl font-just-another-hand text-[#27618E] mb-2 group-hover:text-[#D1BB94] transition-colors uppercase">
                                    {cocktail.name}
                                </h3>
                                <p className="text-[#27618E]/70 text-2xl font-just-another-hand italic leading-tight">
            ...
            {/* 3. Interactive Catalog Grid */}
            <section className="py-24 lg:py-40 px-6 sm:px-12 max-w-[1600px] mx-auto">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-24 gap-8 border-b border-[#27618E]/10 pb-12">
                    <div className="max-w-2xl">
                        <span className="text-[#D1BB94] text-xl tracking-[0.4em] uppercase font-just-another-hand mb-4 block">Inventory</span>
                        <h2 className="text-8xl sm:text-9xl font-just-another-hand uppercase leading-none tracking-tighter mb-8 text-[#27618E]">
                    ...
                    <div className="space-y-12 relative z-10 order-2 lg:order-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            <div className="space-y-4 p-8 bg-[#fcfaf7] border border-[#27618E]/5 rounded-2xl hover:shadow-xl transition-all group/card">
                                ...
                                <h4 className="text-4xl font-just-another-hand text-[#27618E]">Private Tastings</h4>
                                <p className="text-[#27618E]/60 text-xl leading-relaxed tracking-wider uppercase font-just-another-hand italic">Guided exploration of rare Caribbean vintages.</p>
                            </div>
                            <div className="space-y-4 p-8 bg-[#fcfaf7] border border-[#27618E]/5 rounded-2xl hover:shadow-xl transition-all group/card">
                                <ShieldCheck className="w-8 h-8 text-[#D1BB94] mb-4 group-hover/card:scale-110 transition-transform" />
                                <h4 className="text-4xl font-just-another-hand text-[#27618E]">Cocktail Classes</h4>
                                <p className="text-[#27618E]/60 text-xl leading-relaxed tracking-wider uppercase font-just-another-hand italic">Learn the art of tropical mixology.</p>
                            </div>
                        </div>
